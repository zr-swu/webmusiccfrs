...
<html>
  ...
  <body>
    <div class="col-lg-6" style="max-width: 100%;padding:0">
    	<form action="${pageContext.request.contextPath}/admin_user_list" method="post" id="form">
		          ...
		          <div class="card-header" style="padding: 0.53rem 1.25rem;">
		              ...
		              <div style="display:inline-block;padding-left:70px">	
              	  		<input type="text" id="username" name="username" value="${username}" 
              	  			maxlength="20"  class="" style="display:inline-block;" placeholder="请输入用户名" >	
			          	  ...
			          	  <button type="button" class="self_btn" 
			          	    onclick="javascript:location.href='${pageContext.request.contextPath}/admin_user_addOrUpdate'">添加用户</button>
		              </div>
		          </div>
		          <div class="card-body">
		                  		...
		                  		<s:iterator var="user" value="pageBean.list" status="status">
		                  			<tr>
			                      		...
			                      		<td>
			              					...
			              					onclick="javascript:location.href='${pageContext.request.contextPath}/admin_user_addOrUpdate?userid=<s:property value="#user.id"/>'">修改</button>
			                      			&nbsp;&nbsp;
			                      			<button type="button" class="self_btn" style="background-color:#2d6390"
			              					onclick="javascript:doDelete('${pageContext.request.contextPath}/admin_user_delete?userid=<s:property value="#user.id"/>')">删除</button>
			                      		</td>
			                      	</tr>
		                  		</s:iterator>
		                    </s:if>
