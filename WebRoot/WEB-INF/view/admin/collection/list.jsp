    	...
    	<form action="${pageContext.request.contextPath}/admin_score_list" method="post" id="form">
		      ...
		      <div class="card">
		          <div class="card-header" style="padding: 0.53rem 1.25rem;">
		              <strong class="card-title">音乐收藏列表</strong>
		              ...
		              <table class="table table-bordered" style="text-align: center;">
		                  ...
		                  <tbody>
		                  	<s:if test="pageBean!=null && pageBean.list!=null">
		                  		<s:iterator var="collection" value="pageBean.list" status="status">
		                  			<tr>
			                      		<td><s:property value="#status.index+1"/></td>
			                      		<td><s:property value="#collection.user.username"/></td>
			                      		<td><s:property value="#collection.music.musicname"/></td>
			                      		<td>
			                      			<button type="button" class="self_btn" style="background-color:#2d6390"
			              					onclick="javascript:doDelete('${pageContext.request.contextPath}/admin_collection_delete?collectionid=<s:property value="#collection.id"/>')">删除</button>
			                      		</td>
			                      	</tr>
		                  		</s:iterator>
		                    </s:if>
